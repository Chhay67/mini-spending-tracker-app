...
class CustomDropdownButtonFormField2<T> extends StatefulWidget {
  ...
  @override
  State<CustomDropdownButtonFormField2<T>> createState() =>
      _CustomDropdownButtonFormField2State<T>();
}

class _CustomDropdownButtonFormField2State<T>
    extends State<CustomDropdownButtonFormField2<T>> {
  ...
  @override
  void didUpdateWidget(covariant CustomDropdownButtonFormField2<T> oldWidget) {
